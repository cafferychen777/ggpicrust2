...
Update alert! 🚨 ggpicrust2 Ver1.7.2 is now available. Due to some issues with the CRAN server, ggpicrust2 was inadvertently removed from CRAN. We are working diligently to resolve this issue. In the meantime, you can get the latest version from GitHub by using the following command:
...
**Join our official Discord channel for more updates and discussions:** [ggpicrust2 Discord](https://discord.com/invite/yaR7FEc8)
