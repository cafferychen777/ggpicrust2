...
When using the `pathway_daa` function with the ALDEx2 method, you may encounter the following error:
...
This issue may be related to recent updates in the ALDEx2 package that introduced compatibility issues with ggpicrust2. To resolve this issue, you can try installing ALDEx2 v.1.28 from the Bioconductor archive:
